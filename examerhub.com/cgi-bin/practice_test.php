...
<form id="taketest" action="practice_test.php" method="post">
<?php
    if($_GLOBALS['message']) {
...
<div class="row">
	<div class="col-xs-4" style="margin-left:900px;" >
	  	<div class="project project-primary">
			<div class="project-content">
				<br><br>
		  		<div  class="text-center">  Enter Test Code
            	<br><br>
			 		<input type="text" autocomplete="off" class="form-control" tabindex="1" name="tc" value="" size="16" />
			 	<br><br>
...
s.subid=t.subid and u.userid=t.userid and t.testid=3 and CURRENT_TIMESTAMP<t.testto and t.totalquestions=(select count(*) from
		...
		<table class="table">
		   	...
		   	<tbody>
				...
				<?php
					...
					<td style=\"color:#FFFFFF\"><a href=\"practice_test.php?testcode=" . htmlspecialchars_decode($r['testname'], ENT_QUOTES) . "\"><input type=\"button\" value=\"Take Test\" class=\"btn\" style=\"background-color:#0099e5;color:white;padding:5px 5px;\" title=\"Start Test\"></a></td>";
				?>
				<?php
        			}
        			}
