			...
			<div class="w3ls-header-right">
				...
				<li class="dropdown head-dpdn">
					...
					<?php
						 ...
						 ?>
					<li class="dropdown head-dpdn">
						<a href="#"><i class="" aria-hidden="true"></i>Email:info@examerhub.com</a>
					</li>
					<li class="dropdown head-dpdn">
						<a href="#"><span class="active uls-trigger"><i class="fa fa-mobile-alt" aria-hidden="true"></i>Ph:8767875645</span></a>
					</li>
					<li class="dropdown head-dpdn">
		...
		<div class="container">
			<div class="agile-its-header">
				...
				<div class="agileits_search">
					<a class="post-w3layouts-ad" href="taketest.php">Take Test</a>
				</div> 
				<div class="clearfix"></div>
			</div>
		</div>
