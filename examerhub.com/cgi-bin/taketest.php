...
s.subid=t.subid and u.userid=t.userid and CURRENT_TIMESTAMP<t.testto and t.totalquestions=(select count(*) from
		...
		<table class="table">
		   	...
		   	<tbody>
				...
				<?php
					...
					<td style=\"color:#FFFFFF\"><a href=\"taketest.php?testcode=" . htmlspecialchars_decode($r['testname'], ENT_QUOTES) . "\"><input type=\"button\" value=\"Take Test\" class=\"btn\" style=\"background-color:#0099e5;color:white;padding:5px 5px;\" title=\"Start Test\"></a></td>";
				?>
				<?php
        			}
        			}
