		...
		<ul class="rslides" id="slider">
			...
			<li>
				<div class="w3ls-slide-text">
					...
					<a href="taketest.php" class="w3layouts-explore-all">Take Test</a>
				</div>
			</li>
			<li>
				<div class="w3ls-slide-text">
			...
			<li>
				<div class="w3ls-slide-text">
					<h3>Create unlimited online exams with our exam builder. </h3>
					<!--<a href="#" class="w3layouts-explore">Explore</a>-->
				</div>
			</li>
			<li>
				<div class="w3ls-slide-text">
					...
					<a href="#" class="w3layouts-explore">Download App</a>
				</div>
			</li>
		</ul>
	</div>
				...
				<div class="container">
					...
					<div class="focus-grid w3layouts-boder6">
						<a class="btn-8" href="#" data-toggle="modal" data-target="#myModal1">
							<div class="focus-border">
								<div class="focus-layout">
									<div class="focus-image"><i class="glyphicon glyphicon-search
"></i></div>
			...
			<div class="agile-info-mobile-app">
				<div class="container">
					...
					<div class="col-md-7 w3-app-right">
						<h3>Exams are your <span>apportunity</span> at providing your worth to everyone around you.
