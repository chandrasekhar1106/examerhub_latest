	...
	<!-- Navigation -->
		<div class="agiletopbar">
			<div class="wthreenavigation">
				...
				<nav class="menu">
					<div class="icon-list">
                        <a href="practice_test.php"><i class="glyphicon glyphicon-book"></i><span>Practice Test</span></a>
						<a href="taketest.php"><i class="glyphicon glyphicon-pencil"></i><span>Take Test</span></a>
						<a href="viewresult.php"><i class="glyphicon glyphicon-list-alt"></i><span>View Result</span></a>
