...
{
if(empty($_REQUEST['cname'])||empty ($_REQUEST['password'])||empty ($_REQUEST['email'])||empty ($_REQUEST['contactno'])||empty ($_REQUEST['pin'])||empty ($_REQUEST['address'])||empty ($_REQUEST['city']))
    {
...
<?php include_once 'shared/header.php';   ?>
	...
	<div class="agileinfo_signin">
		...
		?>
			...
			<input autocomplete="off" id="" type="password" name="password" placeholder="Password" value="<?php echo htmlspecialchars_decode($r['stdpass'],ENT_QUOTES); ?>"  onkeyup="isalphanum(this)" readonly/>
